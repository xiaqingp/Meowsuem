...
const routePlans = {
  ...
  chichuartmuseum: {
    "90": {
      "title": "90分钟：先看决定性关系",
      "note": "按建筑语境进入，优先看莫奈双联画、德·玛利亚和Open Sky；主动跳过莫奈组内其余四幅与Afrum、Open Field的深入对照。Open Sky按普通开放时段安排，日落项目另计且不可默认使用。",
      "workIds": [
        "chichu-art-museum-underground-architecture-and-site-context",
        "claude-monet-water-lily-pond-c-1915-1926",
    ...
    "half": {
      "title": "半天：看懂三条收藏线",
      "note": "保留建筑语境，完整观看莫奈双联画并加入一件组内对照；德·玛利亚完整停留；特瑞尔按年代看三件。其余三幅莫奈作品留给完整浏览，避免在小馆址内把同一组作品看成重复打卡。",
      "workIds": [
        "chichu-art-museum-underground-architecture-and-site-context",
        "claude-monet-water-lily-pond-c-1915-1926",
        "claude-monet-water-lilies-cluster-of-grass-1914-1917",
        "walter-de-maria-time-timeless-no-time-2004",
    ...
    "all": {
      "title": "完整浏览：十个条目的连续观看",
      "note": "覆盖建筑语境、五幅莫奈、德·玛利亚和三件特瑞尔。应依馆方当日动线与开放状态分配停留；五幅莫奈连续比较题名、年代和尺寸，特瑞尔按1968—2000—2004推进。若参加Open Sky日落Night Program，须先完成其他作品并以当日项目规则为准。",
      "workIds": [
        "chichu-art-museum-underground-architecture-and-site-context",
        "claude-monet-water-lily-pond-c-1915-1926",
        "claude-monet-water-lilies-cluster-of-grass-1914-1917",
        ...
        "claude-monet-water-lilies-reflections-of-weeping-willows-1916-1919",
        "walter-de-maria-time-timeless-no-time-2004",
        "james-turrell-afrum-pale-blue-1968",
        "james-turrell-open-field-2000",
        "james-turrell-open-sky-2004"
