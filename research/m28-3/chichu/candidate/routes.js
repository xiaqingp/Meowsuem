...
const routePlans = {
  ...
  muxin: {
    "90": {title:"90 分钟 · 先抓住两种材料",note:"开放和轮换正常时，先看绘画转变，再把最多时间留给《狱中手稿》与文学馆。",workIds:["fishing-village","pudong-moonlight","dancer","clear-breeze","prison-notes","colombia-draft","world-literature"]},
    ...
    all: {title:"完整路线 · 20 件逐一看",note:"只适合展厅开放、体力充足且愿意读手稿的人；作品轮换时按现场标签替换，不要为集齐清单折返。",workIds:[]}
  },
  louvre: {
...
const contentUpdatedAtByMuseum = {
  ...
  frye:"2026-07-22", louvre:"2026-07-20", met:"2026-07-22", muxin:"2026-07-21", seattle:"2026-07-21", smk:"2026-07-21", vienna:"2026-07-22"
};
